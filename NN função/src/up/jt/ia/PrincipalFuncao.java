...
public class PrincipalFuncao extends JFrame {
	...
	private void enchePBotoes() {
		...
		// JT
		pBotoes.add(new JLabel("Função"), new GridBagConstraints(4, 1, 1, 1, 0, 0, GridBagConstraints.CENTER,
				GridBagConstraints.NONE, new Insets(2, 2, 2, 2), 5, 5));
	...
	// ajusta os pesos das liga��es dos perceptr�es
	...
	// calcula o valor da sa�da dos perceptr�es
